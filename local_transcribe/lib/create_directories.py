...
def ensure_session_dirs(output_dir: str | pathlib.Path, mode: str, speaker_files: dict = None) -> dict[str, pathlib.Path]:
    ...
    Mode can be 'single_file' or 'separate_files'.
    For separate_files, speaker_files dict maps speaker names to file paths.
    """
    ...
    if mode == "separate_files" and speaker_files:
